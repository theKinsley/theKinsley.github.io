...
I received my master\'s degree from Wangxuan Institute of Computer Technology (School of Intelligence and Science Technology, SIST), **Peking University**, and my bachelor\'s degree from the Department of Computer Science and Engineering, National Sun Yat-Sen University. My research interests lie in the fields of **computer vision** and AI-generated content (AIGC), with a primary focus on graphic design generation. In this context, my published papers mainly concentrate on **poster layout generation**. In addition to my scientific research, I\'ve been involved in art promotion for SIST from 2023 to 2025. Feel free to check out a simple [portfolio](hsiaoyuanhsu_portfolio_24.pdf) of my design works if interested.

### Publications & Competitions

- \"Scan-and-Print: Patch-level Data Summarization and Augmentation for Content-aware Layout Generation in Poster Design" @ **IJCAI 2025 (AI, Arts and Creativity)** [[Project]](https://thekinsley.github.io/Scan-and-Print/)[[https://github.com/theKinsley/Scan-and-Print-IJCAI2025]]
